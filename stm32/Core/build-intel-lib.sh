...
PATH=$PATH:/home/deathsea/gcc-arm-none-eabi-7-2018-q2-update/bin/:/d/tools/gcc-arm-none-eabi-9-2020-q2-update-win32/bin/
...
sed -i 's/\(OS_ALIAS     := .*\)/\1 MINGW64_NT-10.0/g;s/\(OS_MAP_LIST  := .*\)/\1 LINUX/g'  makefile.iml_head
